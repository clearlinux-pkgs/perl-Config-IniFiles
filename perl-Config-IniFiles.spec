...
cd %{_builddir}/Config-IniFiles-3.000002
...
cp %{_builddir}/Config-IniFiles-3.000002/LICENSE %{buildroot}/usr/share/package-licenses/perl-Config-IniFiles/38e94f89ec602e1a6495ef7c30477d01aeefedc9
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.1/Config/IniFiles.pm
